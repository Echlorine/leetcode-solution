...
[26. 删除有序数组中的重复项](https://leetcode.cn/problems/remove-duplicates-from-sorted-array/)|(快慢)双指针|~|27, 88, 141|[Python](./Python/26.py)
[27. 移除元素](https://leetcode.cn/problems/remove-element/)|(快慢)双指针|~|26, 88, 141|[Python](./Python/27.py)
...
[55. 跳跃游戏](https://leetcode.cn/problems/jump-game/)|贪心，动态规划|~|~|[Python](./Java/Solution55.java)
[56. 合并区间](https://leetcode.cn/problems/merge-intervals/)|快速排序|~|~|[Java](./Java/Solution56.java)
...
[75. 颜色分类](https://leetcode.cn/problems/sort-colors/)|快速排序，模拟|用指针进行模拟更简单一些|~|[Java](./Java/Solution75.java)
...
[101. 对称二叉树](https://leetcode.cn/problems/symmetric-tree/)|二叉树的遍历|二叉树遍历的主要方法：直接**递归**、用**队列**模拟递归|94, 98|[Java](./Java/Solution101.java)
...
[224. 基本计算器](https://leetcode.cn/problems/basic-calculator/)|栈|~|20, 394|[Java](./Java/Solution224.java)
...
[283. 移动零](https://leetcode.cn/problems/move-zeroes/)|双指针|此题有简易解法|~|[Java](./Java/Solution283.java)
...
[300. 最长递增子序列](https://leetcode.cn/problems/longest-increasing-subsequence/)|动态规划，贪心|~|~|[Java](./Java/Solution300.java)
...
[337. 打家劫舍 III](https://leetcode.cn/problems/house-robber-iii/)|动态规划|树类型的动态规划和后序遍历结合起来用|~|[Java](./Java/Solution337.java)
